...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Switched to "gemini-2.5-flash" model as requested.
    const apiUrl = `https://generativelanguage.googleapis.com/v1/models/gemini-5.5-pro:generateContent?key=${geminiApiKey}`;
